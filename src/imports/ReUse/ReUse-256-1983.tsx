import svgPaths from "./svg-6oevhzplz6";
        ...
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center px-[14px] py-[6px] relative size-full">
            <div className="flex flex-col font-['SF_Pro:Semi_Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#183060] text-[12px] whitespace-nowrap">
              <p className="leading-[16px]">Re-use</p>
            </div>
          </div>
        </div>
      </div>
...
function Frame19() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-full">
      <p className="flex-[1_0_0] font-['SF_Pro:Regular',sans-serif] font-normal leading-[16px] min-h-px min-w-px relative text-[#183060] text-[12px]" style={{ fontVariationSettings: "'wdth' 100" }}>{`Last draw: Lunch (Main) 12:49, 14th Apr `}</p>
...
function Frame18() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-full">
      <p className="flex-[1_0_0] font-['SF_Pro:Regular',sans-serif] font-normal leading-[16px] min-h-px min-w-px relative text-[#183060] text-[12px]" style={{ fontVariationSettings: "'wdth' 100" }}>{`Draw: Tea (+2) 17:49, 12th Apr `}</p>
      <div className="relative shrink-0 size-[16px]" data-name="remove">
        <div className="absolute inset-[0_12.5%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 16">
            <path d={svgPaths.p322d8100} fill="var(--fill-0, #183060)" id="Vector" />
...
function Frame20() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-full">
      <p className="flex-[1_0_0] font-['SF_Pro:Regular',sans-serif] font-normal leading-[16px] min-h-px min-w-px relative text-[#183060] text-[12px]" style={{ fontVariationSettings: "'wdth' 100" }}>{`Draw: Brunch (+1) 11:49, 9th Apr `}</p>
      <div className="relative shrink-0 size-[16px]" data-name="remove">
        <div className="absolute inset-[0_12.5%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 16">
            <path d={svgPaths.p322d8100} fill="var(--fill-0, #183060)" id="Vector" />
...
function Frame17() {
  return (
    <div className="bg-[#f8f9fa] flex-[1_0_0] min-h-px min-w-px relative rounded-[12px] w-full">
      <div aria-hidden="true" className="absolute border border-[#f3f3f3] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[12px] items-center py-[12px] relative size-full">
          <AllDraws />
          <AllDraws1 />
          <AllDraws2 />
        </div>
  ...
  return (
    <div className="bg-[#f8f9fa] content-stretch flex items-center justify-center p-[12px] relative shrink-0 w-[375px]">
      <div className="content-stretch flex h-[36px] items-start justify-center px-[16px] py-[10px] relative rounded-[4px] shrink-0 w-[200px]" data-name="button-collection / primary-button">
        ...
        <p className="font-['SF_Pro:Regular',sans-serif] font-normal leading-[16px] relative shrink-0 text-[#acadb6] text-[12px] text-center whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
          Confirm
        </p>
      </div>
    </div>
...
export default function ReUse() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center overflow-clip relative rounded-tl-[30px] rounded-tr-[30px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] size-full" data-name="Re-use">
      <Container />
      <Options />
      <Frame6 />
      <Container1 />
