import svgPaths from "./svg-q9rdddnf34";
        ...
        <div className="overflow-clip relative rounded-[inherit] size-full">
          <div className="absolute inset-[-12%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 62 62">
              <g filter="url(#filter0_d_202_1073)" id="Vector">
                <path d={svgPaths.p3c133780} fill="var(--fill-0, white)" />
              </g>
              <defs>
                <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="62" id="filter0_d_202_1073" width="62" x="0" y="0">
                  ...
                  <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_202_1073" />
                  <feBlend in="SourceGraphic" in2="effect1_dropShadow_202_1073" mode="normal" result="shape" />
                </filter>
              </defs>
            </svg>
          </div>
      ...
      <div className="relative shrink-0 size-[16px]" data-name="favs">
        <div className="absolute inset-[2.5%_0]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 15.2">
            <path d={svgPaths.p35aa7300} fill="url(#paint0_linear_202_1063)" id="Vector" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_202_1063" x1="0" x2="16" y1="7.6" y2="7.6">
