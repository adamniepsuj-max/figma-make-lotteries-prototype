import svgPaths from "./svg-3075o10aig";
...
function ActiveBreadcrumb({ children }: { children: string }) {
  return (
    <div className="content-stretch flex h-[16px] items-center justify-center overflow-clip relative shrink-0" data-name="breadcrumb">
      <p className="font-['SF_Pro:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[12px] text-center text-white underline decoration-white decoration-[1px] underline-offset-[2px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        {children}
      </p>
    </div>
  );
...
function NagivationContainer({ activeBreadcrumb = "Irish lotto" }: { activeBreadcrumb?: string }) {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[4px] items-center min-h-px min-w-px overflow-clip relative" data-name="nagivation-container">
      ...
      <div className="content-stretch flex gap-[4px] items-center overflow-clip py-[2px] relative shrink-0" data-name="Breadcrumb Item 02">
        <Breadcrumb>All lotteries</Breadcrumb>
        <div className="bg-[#9ba9c1] h-[12px] shrink-0 w-px" data-name="separator" />
      </div>
      <div className="content-stretch flex gap-[4px] items-center overflow-clip py-[2px] relative shrink-0" data-name="Breadcrumb Item 03">
        <ActiveBreadcrumb>{activeBreadcrumb}</ActiveBreadcrumb>
      </div>
    </div>
  );
}
...
export default function Frame({ onBack, activeBreadcrumb }: FrameProps) {
  return (
    <div className="content-stretch flex flex-col items-start relative size-full">
      ...
      <div className="bg-[#060a2a] content-stretch flex flex-col gap-[12px] items-start justify-center overflow-x-auto overflow-y-clip pb-[12px] pt-[16px] relative shrink-0 w-full" data-name="page-title-collection / page-title">
        <div className="content-stretch flex gap-[8px] items-center overflow-clip px-[12px] relative shrink-0 w-[320px]" data-name="breadcrumb">
          <button
            onClick={onBack}
            className="content-stretch flex items-center relative shrink-0 size-[16px] cursor-pointer hover:opacity-80 transition"
            data-name="helix / icon"
          >
          ...
          <NagivationContainer activeBreadcrumb={activeBreadcrumb} />
        </div>
        <HeaderDetails />
      </div>
    </div>
