import svgPaths from "./svg-nu3q0u4tkk";
...
function Frame10() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center relative shrink-0 w-[260px]">
      <Frame11 />
    </div>
  );
}
...
function Frame9() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start justify-center relative shrink-0">
      <p className="font-['SF_Pro:Regular',sans-serif] font-normal leading-[16px] relative shrink-0 text-[#5b7395] text-[12px] text-center whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function NumbersSelectionGrid() {
  return (
    <div className="backdrop-blur-[6px] bg-[rgba(255,249,240,0.2)] gap-x-[12px] gap-y-[12px] grid-cols-[repeat(7,fit-content(100%))] grid-rows-[repeat(7,fit-content(100%))] inline-grid p-[17px] relative rounded-[10px] shrink-0" data-name="numbers selection grid">
      <div aria-hidden="true" className="absolute border border-[#fff9f0] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <Container22 />
      <Container23 />
      <Container24 />
      <Container25 />
...
function Frame14() {
  return (
    <div className="bg-[#f8f9fa] content-stretch flex flex-col gap-[16px] h-[454px] items-center py-[12px] relative rounded-[12px] shrink-0 w-[351px]">
      <div aria-hidden="true" className="absolute border border-[#f3f3f3] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <AllDraws />
...
export default function NewBb() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center overflow-clip relative rounded-tl-[30px] rounded-tr-[30px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] size-full" data-name="New + bb">
      <Container />
      <Options />
      <Frame6 />
      <Container1 />
