import svgPaths from "./svg-dvr4batt1f";
...
export default function Favourite() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center overflow-clip relative rounded-tl-[30px] rounded-tr-[30px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] size-full" data-name="Favourite">
      <Container />
      <Options />
      <Frame6 />
      <Container1 />
