import svgPaths from "./svg-5qvogq13zv";
      ...
      <div className="bg-white h-[80px] relative rounded-[8px] shadow-[0px_0px_18px_0px_rgba(23,31,51,0.1)] shrink-0 w-full" data-name="lotto tile">
        <div className="content-stretch flex gap-[12px] items-start px-[8px] py-[12px] relative size-full">
          <div className="h-full relative shrink-0">
            <div className="content-stretch flex h-full items-start pt-[18px] relative">
          ...
          <div className="h-full relative shrink-0">
            <div className="content-stretch flex h-full items-start pb-[8px] pt-[6px] relative">
              <div className="relative rounded-[50px] shrink-0 size-[36px]" data-name="ireland">
                <div className="overflow-clip relative rounded-[inherit] size-full">
                  <div className="absolute inset-[-16.67%]">
                    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 48 48">
                      <g filter="url(#filter0_d_230_1173)" id="Vector">
                        <path d={svgPaths.p3289ce00} fill="var(--fill-0, white)" />
                      </g>
                      <defs>
                        <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="48" id="filter0_d_230_1173" width="48" x="0" y="0">
                          ...
                          <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_230_1173" />
                          <feBlend in="SourceGraphic" in2="effect1_dropShadow_230_1173" mode="normal" result="shape" />
                        </filter>
                      </defs>
                    </svg>
                  </div>
          ...
          <div className="content-stretch flex flex-col h-full items-center justify-center relative shrink-0 w-[101px]">
            <div className="relative rounded-[4px] shrink-0 w-[101px]" data-name="button-collection / primary-button">
              <div className="content-stretch flex items-start justify-center overflow-clip px-[12px] py-[6px] relative rounded-[inherit] w-full">
